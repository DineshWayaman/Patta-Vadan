...
public class EnglishImageView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_image_view);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(EnglishImageView.this,e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    private void saveImage() {
        ...
        try {
            ...
            Toast.makeText(EnglishImageView.this, "Save Image In To Gallery", Toast.LENGTH_SHORT).show();
        }
        catch (Exception e){
            Toast.makeText(EnglishImageView.this,e.getMessage(), Toast.LENGTH_SHORT).show();
        }
