...
import com.wcreation.vadan.EnglishImageView;
...
public class EnglishImageRecyclerViewAdapter extends RecyclerView.Adapter<EnglishImageRecyclerViewAdapter.MyViewHolder> {

    private Context mContext ;
    private List<Anime> mData ;
    RequestOptions option;

    public EnglishImageRecyclerViewAdapter(Context mContext, List<Anime> mData){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext, EnglishImageView.class);
