...
public class SinhalaJokeImage extends AppCompatActivity {

    private final String JSON_URL = "https://drive.google.com/u/3/uc?id=1JeQzHzBtycemCzyuTQZSJ60r23AmXibq&export=download";
    ...
    private final String TAG = SinhalaJokeImage.class.getSimpleName();
    private InterstitialAd interstitialAd;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sinhala_joke_image);
        ...
        recyclerView = findViewById(R.id.recyclerviewiJoke);
        jsonrequest();
    ...
    private void jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(SinhalaJokeImage.this);
